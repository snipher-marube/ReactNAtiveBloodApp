    ...
    return (
        <View style={[styles.main, commonJustify.rowSpaceBetween]}>
           ...
           <View style={[styles.margin]}>
            ...
            <Text style={commonStyle({fontSize:14, fontFamily:fontValue.PoppinsBold,color:colorValue.liteDark2}).text}>{item.name}</Text>
            </View>

            <View style={[styles.margin]}>
            <Text style={commonStyle({fontSize:13, fontFamily:fontValue.PoppinsRegular}).text}>Location</Text>
            <Text style={commonStyle({fontSize:14, fontFamily:fontValue.PoppinsBold,color:colorValue.liteDark2}).text}>{item.location}</Text>
            </View>
           ...
           <View  style={{paddingTop:20}} >
               <Image style={{width:100, }} resizeMode="contain" source={require("../../../../../assests/images/BloodGroup.png")}/>
